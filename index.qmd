...
2.  **Understand your data.**
    ...
    a.  Take inventory of source data (tools: White Rabbit)
    ...
    b.  Define relationships between source data tables and fields (tools: Rabbit-in-a-Hat)
...
3.  **Map your codes to OMOP concepts.**
    ...
    b.  Create your source data to OMOP mapping. (tools: Usagi)
